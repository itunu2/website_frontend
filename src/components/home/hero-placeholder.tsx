    ...
    <div className="bg-bg-elevated py-24 sm:py-32">
      <Container className="grid gap-10 lg:grid-cols-2">
        <div className="space-y-6">
          <p className="text-body-sm uppercase tracking-[0.4em] text-text-soft">Editorial Website</p>
        ...
        <div className="space-y-6 rounded-3xl border border-border-subtle bg-bg-surface/80 p-8 shadow-soft">
